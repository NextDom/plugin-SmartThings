...
<div class="row row-overflow">
	<div class="col-xs-12 eqLogicThumbnailDisplay">
		...
		<div class="eqLogicThumbnailContainer">
			<div class="cursor eqLogicAction logoSecondary" id="bt_syncSmartThings" >
			...
			<div class="cursor logoSecondary" id="bt_healthSmartThings">
				...
				<br/>
					<form class="form-horizontal">
						<fieldset>
							...
							<br />
							<div class="form-group">
								<label class="col-lg-3 control-label">{{SmartThings Room : }}</label>
                                                                <div class="col-lg-3">
                                                                         <input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="roomName"  readonly/>
                                                                </div>
							</div>
						</fieldset>
					</form>
