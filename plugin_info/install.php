...
function smartthings_update() {
    ...
    // Fix pour mon oubli
     foreach (eqLogic::byType('smartthings') as $smartthings) {
        $allCmd = cmd::byEqLogicId($smartthings->getId());
    ...
    $cmd->setConfiguration('value', '#select#');
    message::add('smartthings', 'Merci pour la mise à jour de ce plugin, faites une synchronisation pour mettre à jour les commandes.');
}
